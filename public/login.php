...
<body>
    <div class="container">
        <div id="loginApp" class="row">
            <form id="loginForm">
                <h2 id="loginHeader" class="d-flex text-align-center justify-content-center mb-5">Login</h2>

                <label for="loginUsername">Username</label>
                <input type="text" id="loginUsername" name="loginUsername" class="form-control mb-3">

                <label for="loginPassword">Password</label>
                <div class="input-box mb-5 position-relative">
                ...
                <a class="d-flex text-align-center justify-content-center mb-3" href="register.php">Create Account</a>
